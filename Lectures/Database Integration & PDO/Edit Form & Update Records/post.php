...
<body class="bg-gray-100">
  ...
  <div class="container mx-auto p-4 mt-4">
    <div class="md my-4">
      ...
      <!--- Edit Form -->
      <a href="edit.php?id=<?= $post['id'] ?>" class="bg-green-500 text-white px-4 py-2 rounded block w-full text-center mb-4 hover:bg-green-600 foocus:outline-none">Edit</a>
